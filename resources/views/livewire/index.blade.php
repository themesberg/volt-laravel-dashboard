        ...
        <div class="container">
            ...
            <div class="row justify-content-between align-items-center mb-5 mb-lg-7">
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <a href="https://demo.themesberg.com/volt-pro/pages/kanban" target="_blank" class="btn btn-secondary d-inline-flex align-items-center me-3">
            ...
            <div class="row justify-content-between align-items-center mb-5 mb-lg-7">
                <div class="col-lg-5 order-lg-2 mb-5 mb-lg-0">
                    ...
                    <a href="https://demo.themesberg.com/volt-pro/pages/map" target="_blank" class="btn btn-secondary d-inline-flex align-items-center me-3">
            ...
            <div class="row justify-content-between align-items-center mb-5 mb-lg-7">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="mb-4 lead fw-bold">Advanced FullCalendar.js integration</p>
                    <p class="mb-4">We created a fully editable calendar where you can add, edit and delete events for your admin dashboard.</p>
                    <a href="https://demo.themesberg.com/volt-pro/pages/calendar" target="_blank" class="btn btn-secondary d-inline-flex align-items-center me-3">
        ...
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-6 mb-5">
                    <a href="/dashboard" class="page-preview scale-up-2">
                ...
                <div class="col-6 mb-5">
                    <a href="transactions" class="page-preview scale-up-2">
                ...
                <div class="col-6 mb-5">
                    <a href="/sign-in" class="page-preview scale-up-2">
                ...
                <div class="col-6 mb-5">
                    <a href="/sign-up" class="page-preview scale-up-2">
                ...
                <div class="col-6 mb-5">
                    <a href="/lock" class="page-preview scale-up-2">
                ...
                <div class="col-6 mb-5">
                    <a href="/forgot-password" class="page-preview scale-up-2">
                ...
                <div class="col-6 mb-5">
                    <a href="/reset-password-example" class="page-preview scale-up-2">
                ...
                <div class="col-6 mb-5">
                    <a href="/404" class="page-preview scale-up-2">
                ...
                <div class="col-6 mb-5">
                    <a href="/500" class="page-preview scale-up-2">
            ...
            <div class="row mt-6">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-5 mb-lg-0">
                    <div class="card shadow border-0 p-4 py-5 mt-lg-n5">
                        ...
                        <a href="https://demo.themesberg.com/volt-pro/index" target="_blank" class="btn btn-secondary d-flex align-items-center justify-content-center mb-0 mt-2">Demo Volt Pro <svg class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z"></path><path d="M5 5a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H5V7h3a1 1 0 000-2H5z"></path></svg></a>
                        <!-- End Content -->
                    </div>
                </div>
            </div>
